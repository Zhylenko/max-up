...
/*!************************!*\
  !*** ./app/js/main.js ***!
  \************************/
/*! no exports provided */function(module,__webpack_exports__,__webpack_require__){"use strict";eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_active__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/active */ \"./app/js/modules/active.js\");\n/* harmony import */ var _modules_validator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/validator */ \"./app/js/modules/validator.js\");\n/* harmony import */ var _modules_login__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/login */ \"./app/js/modules/login.js\");\n/* harmony import */ var _modules_links__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/links */ \"./app/js/modules/links.js\");\n/* harmony import */ var _modules_front__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/front */ \"./app/js/modules/front.js\");\n/* harmony import */ var _modules_symtext__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/symtext */ \"./app/js/modules/symtext.js\");\n/* harmony import */ var _modules_stroketext__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/stroketext */ \"./app/js/modules/stroketext.js\");\n/* harmony import */ var _modules_seo_text__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/seo-text */ \"./app/js/modules/seo-text.js\");\n/* harmony import */ var _modules_reviews__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/reviews */ \"./app/js/modules/reviews.js\");\n/* harmony import */ var _modules_addfunds__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/addfunds */ \"./app/js/modules/addfunds.js\");\n/* harmony import */ var _modules_promocode__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/promocode */ \"./app/js/modules/promocode.js\");\n/* harmony import */ var _modules_newOrder__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/newOrder */ \"./app/js/modules/newOrder.js\");\n/* harmony import */ var _modules_cart__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/cart */ \"./app/js/modules/cart.js\");\n/* harmony import */ var _modules_postRequest__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/postRequest */ \"./app/js/modules/postRequest.js\");\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nwindow.addEventListener('DOMContentLoaded', function () {\n  Object(_modules_active__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('burger', 'sidebar', 'pre', 'blur'); // validator('reg_form','._req', '.form-error');\n  // validatorLogin('login__form', '._req', '.form-error');\n  // front();\n\n  Object(_modules_postRequest__WEBPACK_IMPORTED_MODULE_13__[\"default\"])();\n  Object(_modules_symtext__WEBPACK_IMPORTED_MODULE_5__[\"default\"])('textarea-text', '.text');\n  Object(_modules_stroketext__WEBPACK_IMPORTED_MODULE_6__[\"default\"])('.textarea-stroke', '.stroke');\n  Object(_modules_seo_text__WEBPACK_IMPORTED_MODULE_7__[\"default\"])('.seo-textarea', '.seo-span', '.seo-list');\n  Object(_modules_reviews__WEBPACK_IMPORTED_MODULE_8__[\"default\"])('reviews-form', '.review-textarea', 'submit_review');\n  Object(_modules_addfunds__WEBPACK_IMPORTED_MODULE_9__[\"default\"])('balance-form', '._req', '.form-error');\n  Object(_modules_promocode__WEBPACK_IMPORTED_MODULE_10__[\"default\"])('promo', '._req', '.form-error');\n  Object(_modules_newOrder__WEBPACK_IMPORTED_MODULE_11__[\"default\"])('addToCart-form', '.order-input', '._req', '.form-error', '.span-dop', '.order__form-calculator');\n  Object(_modules_cart__WEBPACK_IMPORTED_MODULE_12__[\"default\"])();\n});\n\n//# sourceURL=webpack:///./app/js/main.js?")},"./app/js/modules/active.js":
/*!**********************************!*\
  !*** ./app/js/modules/active.js ***!
  \**********************************/
/*! exports provided: default */function(module,__webpack_exports__,__webpack_require__){"use strict";eval("__webpack_require__.r(__webpack_exports__);\nvar openMenu = function openMenu(button, menu, pre, blur) {\n  var btn = document.getElementById(button),\n      sidebar = document.getElementById(menu),\n      allSide = document.getElementById(pre),\n      addBlur = document.getElementById(blur);\n  var body = document.querySelector('body');\n  var scroll = calcScroll();\n  var isOpen = false;\n  btn.addEventListener('click', function () {\n    if (!isOpen) {\n      btn.classList.add('active');\n      sidebar.classList.add('active');\n      allSide.classList.add('open');\n      addBlur.classList.add('blured');\n\n      if (window.innerHeight < document.body.clientHeight) {\n        body.style.overflow = 'hidden';\n        body.style.marginRight = \"\".concat(scroll, \"px\");\n      }\n\n      isOpen = true;\n    } else {\n      btn.classList.remove('active');\n      sidebar.classList.remove('active');\n      allSide.classList.remove('open');\n      addBlur.classList.remove('blured');\n      body.style.overflow = 'auto';\n      body.style.marginRight = \"0px\";\n      isOpen = false;\n    }\n  });\n  allSide.addEventListener('click', function (e) {\n    if (e.target === allSide) {\n      if (isOpen) {\n        btn.classList.remove('active');\n        sidebar.classList.remove('active');\n        allSide.classList.remove('open');\n        addBlur.classList.remove('blured');\n        body.style.overflow = 'auto';\n        body.style.marginRight = \"0px\";\n        isOpen = false;\n      }\n    }\n  });\n};\n\nfunction calcScroll() {\n  var div = document.createElement('div');\n  div.style.width = '50px';\n  div.style.height = '50px';\n  div.style.overflowY = 'scroll';\n  div.style.visibility = 'hidden';\n  document.body.appendChild(div);\n  var scrollWidth = div.offsetWidth - div.clientWidth;\n  div.remove();\n  return scrollWidth;\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (openMenu);\n\n//# sourceURL=webpack:///./app/js/modules/active.js?")},"./app/js/modules/addfunds.js":
/*!************************************!*\
  !*** ./app/js/modules/addfunds.js ***!
  \************************************/
/*! exports provided: default */function(module,__webpack_exports__,__webpack_require__){"use strict";eval("__webpack_require__.r(__webpack_exports__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nvar addToBalance = function addToBalance(formID, regInputs, errorLabels) {\n  // HTML Elelemts\n  var form = document.getElementById(formID),\n      reqs = document.querySelectorAll(regInputs),\n      labels = document.querySelectorAll(errorLabels);\n  var radioElements = document.getElementsByName('pay-checkbox');\n  var balance = document.querySelector('.cart-total-price');\n  var object = {\n    balance: 0\n  };\n\n  if (form !== null) {\n    var formSend = /*#__PURE__*/function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {\n        var errorCount, formData, json, path, headers;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                e.preventDefault();\n                errorCount = miniValidator(reqs, labels);\n                formData = new FormData(form);\n                formData.forEach(function (item, key) {\n                  object[key] = item;\n                });\n                delete object.checkbox;\n                json = JSON.stringify(object);\n\n                if (errorCount === 0) {\n                  // Send Attribute\n                  path = 'file.php';\n                  headers = {\n                    'Content-Type': 'application/json',\n                    'Accept': 'application/json'\n                  };\n                }\n\n              case 7:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee);\n      }));\n\n      return function formSend(_x) {\n        return _ref.apply(this, arguments);\n      };\n    }();\n\n    form.addEventListener('submit', formSend);\n  }\n};\n\nvar numberTest = function numberTest(input) {\n  return !/^[0-9]+$/.test(input.value);\n};\n\nfunction miniValidator(formReq, labels) {\n  var errors = 0;\n  var checkbox = document.querySelector('.form-checkstyle');\n\n  for (var index = 0; index < formReq.length; index++) {\n    var input = formReq[index];\n    var label = labels[index];\n    removeError(input);\n    checkbox.classList.remove('_error');\n    label.style.display = 'none';\n\n    if (input.value === '') {\n      addError(input);\n      label.style.display = 'block';\n      errors++;\n    } else if (input.classList.contains('_balance')) {\n      if (numberTest(input)) {\n        addError(input);\n        label.textContent = 'Введите корректную сумму';\n        label.style.display = 'block';\n        errors++;\n      }\n    } else if (input.getAttribute('type') === 'checkbox' && input.checked === false) {\n      addError(input);\n      checkbox.classList.add('_error');\n      errors++;\n    }\n  }\n\n  return errors;\n}\n\nfunction addError(input) {\n  input.classList.add('_error');\n}\n\nfunction removeError(input) {\n  input.classList.remove('_error');\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (addToBalance);\n\n//# sourceURL=webpack:///./app/js/modules/addfunds.js?")},"./app/js/modules/cart.js":
/*!********************************!*\
  !*** ./app/js/modules/cart.js ***!
  \********************************/
/*! exports provided: default */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\nvar cart = function cart() {};\n\n/* harmony default export */ __webpack_exports__["default"] = (cart);\n\n//# sourceURL=webpack:///./app/js/modules/cart.js?')},"./app/js/modules/front.js":
/*!*********************************!*\
